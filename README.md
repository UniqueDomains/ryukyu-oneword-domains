# Available .RYUKYU One-Word Domains (7,869)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-7%2C869%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **7,869 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 7,869 domains · **Median ask:** $22.24 · **High-demand under $2,500:** 27
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------- |
| one.ryukyu      | available | $22.98    | —             | high           | medium | 3      | namecheap |
| off.ryukyu      | available | $22.98    | —             | high           | low    | 3      | namecheap |
| pure.ryukyu     | available | $22.98    | —             | high           | medium | 4      | namecheap |
| smooth.ryukyu   | available | $22.98    | —             | high           | low    | 6      | namecheap |
| colour.ryukyu   | available | $22.98    | —             | high           | high   | 6      | namecheap |
| career.ryukyu   | available | —         | —             | high           | low    | 6      | —         |
| above.ryukyu    | available | $22.98    | —             | high           | low    | 5      | namecheap |
| negative.ryukyu | available | $22.98    | —             | high           | low    | 8      | namecheap |
| zero.ryukyu     | available | $22.98    | —             | high           | medium | 4      | namecheap |
| motive.ryukyu   | available | $22.98    | —             | high           | medium | 6      | namecheap |
| shame.ryukyu    | available | $22.98    | —             | high           | low    | 5      | namecheap |
| only.ryukyu     | available | $22.98    | —             | high           | medium | 4      | namecheap |
| advance.ryukyu  | available | $22.98    | —             | high           | low    | 7      | namecheap |
| joint.ryukyu    | available | $22.98    | —             | high           | low    | 5      | namecheap |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 7,869 live domains                         |
...
> Unique Domains. *Available .RYUKYU One-Word Domains*. Version 2026-08-24. Public GitHub extract for the exact Unique Domains search represented by this repository.
